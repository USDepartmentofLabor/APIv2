...
$contact_name = array('class'=>'form-control', 'name' => 'contact_name', 'id'=>'contact_name', 'placeholder'=>'Contact name');
$email = array('class'=>'form-control', 'name' => 'email_address', 'type'=>'hidden');
$message = array('class' => 'form-control', 'name' => 'message_area', 'id' => 'message', 'rows' => '5', 'cols'=> '40', 'placeholder'=>'Explain what happened exactly when you tried to register...');
